...
const MC = (() => {
  ...
  async function loadAllTrades() {
    ...
    // Raw lower-case headers needed to distinguish "P&L $" vs "P&L %" — both normalize to "p_l"
    ...
    // P&L % detection: use raw headers to find the % variant, fallback to second "p_l" occurrence
